...
const headers = [
  ...
  { text: 'Perguntas', value: 'questions', sortable: false },
...
const saveForm = async (formData) => {
  console.log('formData.pai', formData.value)
  try {
...
<template>
  <Head title="Gerenciamento de Formulários" />
    ...
    <template v-slot="{ canAccess }">
      <v-container fluid fill-height>
        <FormList
          :headers="headers"
          :items="forms"
          searchPlaceholder="Pesquisar Formulários"
          createButtonLabel="Adicionar Formulário"
